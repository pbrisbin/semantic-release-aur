...
describe("updatePKGBUILDVersion", () => {
    it("updates pkgver and resets pkgrel", () => {
        fs_1.default.writeFileSync("PKGBUILD", [
        ...
        try {
            (0, pkg_1.updatePKGBUILDVersion)("1.2.0");
            const updated = fs_1.default.readFileSync("PKGBUILD", "utf-8");
            expect(updated.split("\n").find((l) => l.startsWith("pkgver"))).toBe("pkgver=1.2.0");
            expect(updated.split("\n").find((l) => l.startsWith("pkgrel"))).toBe("pkgrel=1");
        }
        finally {
            fs_1.default.unlinkSync("PKGBUILD");
        }
    });
});
